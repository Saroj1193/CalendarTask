...
- (void)reloadDataForCell:(FSCalendarCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.titleLabel.text = [NSString stringWithFormat:@"%@%@", @" ",[self.dataSourceProxy calendar:self titleForDate:date] ?: @([self.gregorian component:NSCalendarUnitDay fromDate:date]).stringValue];
    
    BOOL today = [[NSCalendar currentCalendar] isDateInToday:date];
    
    cell.titleLabel.font = today ? [UIFont fontWithName:@"Lato-Semibold" size:14] : [UIFont fontWithName:@"Lato-Regular" size:14];
