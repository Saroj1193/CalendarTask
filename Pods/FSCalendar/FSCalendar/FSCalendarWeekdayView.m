...
- (void)commonInit
{
    ...
    for (int i = 0; i < 7; i++) {
        ...
        CGFloat w = (UIScreen.mainScreen.bounds.size.width - 32) / 7;
        UIView *view2 = [[UILabel alloc] initWithFrame:CGRectZero];
        view2.frame = CGRectMake(i*w, 35, w, 1);
        view2.backgroundColor = [[UIColor lightGrayColor] colorWithAlphaComponent:0.3];
